...
SECRET_KEY = 'django-insecure-v%ke#ox$towzoa0apcq#pkm5b2u@ci$rvtn4d2f77+-mw)zv%h'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['premier.classapparelph.com']
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('MYSQL_DATABASE', 'premier_db'),
        'USER': os.getenv('MYSQL_USER', 'premier_user'),
        'PASSWORD': os.getenv('MYSQL_PASSWORD', 'P9i!cT@wY7eZ3oS5'),
